...
ui<-fluidPage(
  ...
  selectInput(inputId = "state", label = "Choose a state to zoom in on:",
  ...
  plotOutput("map"),
  fluidRow(
    column(6, align = "center", "Histogram of County TFP Price",
           fluidRow(plotOutput("yr"))),
    column(6, align = "center", textOutput("statemapyr"),
